...
PARAMETER_FILE_TAGS="Parameter File Tags"
...
<#macro renderReportSummary>
	...
	<@card headerTitle="">
		...
		<@renderFormRow label=PARAMETER_FILE_TAGS field=model.report.parameterFileTags/>
...
<#macro renderReportGeneral>
	...
	<#if model.report.headline?has_content || model.report.owner?has_content || model.report.description?has_content || model.report.tags?has_content || model.report.testCaseId?has_content || model.report.testCaseName?has_content || model.report.namespace?has_content || model.report.runBy?has_content>	
		<@card headerTitle=GENERAL_HEADER>
			...
			<@renderFormRow label=RUNBY field=model.report.runBy/>
